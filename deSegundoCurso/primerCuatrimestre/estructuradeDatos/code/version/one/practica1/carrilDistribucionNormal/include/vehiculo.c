...
vehiculo::vehiculo()
{
    seta_n(distribucion_normal(0.9, 0.5, 1 / 2));
    setb_n(distribucion_normal(1, 0.5, 1 / 2));
    setb(distribucion_normal(2.0, 0.5, 1 / 2));
    sets_n(distribucion_normal(1.6, 0.5, 1 / 2));
    setx_n(0);
    setV_n(distribucion_normal(1.8, 0.5, 1 / 2));
    settau(CTAU);
    v_n = 0.10;
    ptrsiguiente = 0;
    ptranterior = 0;
